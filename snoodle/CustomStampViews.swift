...
struct DoodleStampCreatorView: View {
    ...
    func doodleTextComposerSheet() -> some View {
        ...
        TextComposerSheet(
            ...
            initialShadowEnabled: editStamp?.shadowEnabled,
            initialShadowColor: editStamp?.shadowColor,
            initialShadowBlur: editStamp?.shadowBlur,
            initialShadowOffsetX: editStamp?.shadowOffsetX,
            initialShadowOffsetY: editStamp?.shadowOffsetY,
